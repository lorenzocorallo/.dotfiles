return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>en", function() builtin.find_files { cwd = vim.fn.stdpath"config" } end, { desc = "[E]dit [N]eovim Config" })
    ...
    -- lsp-related
    vim.keymap.set("n", "<leader>vds", require("telescope.builtin").lsp_document_symbols, { desc = "[V]iew [D]ocument [S]ymbols" })
